...
import lib.kalu.permission.core.support.SuppportAudioRecord;
...
public class PlatformSupport {
    ...
    public static boolean isPermissionGranted(Activity activity, String permission) {
        try {
            ...
            Log.e(TAG, "throwing exception in PermissionChecker:  " + e.getMessage(), e);
            return false;
        }
    }
     ...
     * in PlatformMeizu 5.0~6.0, just according normal phone request
     * in PlatformMi 6.0~, need force judge
     * in PlatformMi 5.0~6.0, not test!!!
     *
     * @param activity
     * @return true if success
     * @throws Exception
    ...
    private static boolean checkReadSms(Activity activity) throws Exception {
        ...
        if (PlatformSupport.isForceManufacturer()) {
